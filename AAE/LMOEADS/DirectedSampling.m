function [GuidingSolution,FEs] = DirectedSampling(Problem,Population,Ns,Nw,RefV,FEs,t)
...
% E-mail: shufen.qin@stu.tyust.edu.cn
    ...
    [SampleSolution,FEs]  = GenerateSampleSolution(Problem,RandSample,Direction,FEs,t);
...
function [SampleSolution,FEs] = GenerateSampleSolution(Problem,RandSample,Direct,FEs,t)
% Generate some sample solutions along with the guiding directions
   ...
   for i = 1:Ns
       ...
       for k = 1:size(PopX,1)
           X = PopX(k,:);
           Y = Problem.Evaluation(PopX(k,:),t)';
           SampleSolutiontemp = SOLUTION(X,Y);
            FEs = FEs+1;
